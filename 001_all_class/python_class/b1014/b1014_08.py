...
# 매개변수로 전달이 되면, return 없어도 값이 변경되어 전달됨.
# def add(h):
...
# print(1,2,3,4,4,5,5,sep=',',end='\t') # 가변 매개변수
# print("안녕")
